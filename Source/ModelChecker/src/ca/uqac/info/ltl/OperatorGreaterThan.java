...
/**
 * Implementation of the "greater than" relation
 * @author Sylvain Hallé
 *
 */
public class OperatorGreaterThan extends BinaryOperator
{
  ...
  public OperatorGreaterThan(Operator left, Operator right)
  {
    super(left, right);
    m_symbol = SYMBOL;
    m_commutes = true;
